...
def prepare_for_data_retention(unlock_all=False, lock_interval=90, project_name_filter=None):
...
def main():
    ...
    if args.lock:
        ...
        prepare_for_data_retention(unlock_all=False, lock_interval=interval, project_name_filter=args.project_name)
    elif args.unlockall:
        if args.project_name:
